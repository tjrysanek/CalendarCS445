...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    <div class="col bg-white rounded p-3 pl-4" style="overflow-y:scroll; width:65%; margin:10px">
        <button class="btn btn-primary" onclick="window.location.replace('./eventInput.html')">New Event</button>
        <button class="btn btn-secondary" style="background-color: red; color: white;" onclick="removeEvent()">Remove Event</button>
        <div class="pt-2 pb-3">
                <div class="row pt-2">
                    <div class="col-1">
                        <h2 class="mb-0 text-primary">4</h2>
                    </div>
                    <div class="col">
                        <h4 class="mb-0 mt-2">Workshop Back To School</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1"></div>
                    <div class="col">
                        <p class="mb-0 mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <div class="pt-2 pb-3">
                <div class="row pt-2">
                    ...
                    <div class="col">
                        <h4 class="mb-0 mt-2">Lunch Box Philosophers</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1"></div>
            ...
            <div class="pt-2 pb-3">
                <div class="row pt-2">
                    <div class="col-1">
                        <h2 class="mb-0 text-primary">13</h2>
                    </div>
                    <div class="col">
                        <h4 class="mb-0 mt-2">Get to learn python</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1"></div>
            ...
            <div class="pt-2 pb-3">
                <div class="row pt-2">
                    <div class="col-1">
                        <h2 class="mb-0 text-primary">24</h2>
                    </div>
                    <div class="col">
                        <h4 class="mb-0 mt-2">Meet the dean</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1"></div>
            ...
            <div class="pt-2 pb-3">
                <div class="row pt-2">
                    <div class="col-1">
                        <h2 class="mb-0 text-primary">29</h2>
                    </div>
                    <div class="col">
                        <h4 class="mb-0 mt-2">Django Con</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-1"></div>
